...
Staff Member: ${result.staff_name || 'Staff'}
...
Confidence: ${confidence} | Est. Tokens: ${tokenCost}
    `.trim();
    ...
    link.href = url;
    link.download = `upsell_script_${(result.customer_name || 'customer').replace(/\s+/g, '_')}.txt`;
    link.click();
